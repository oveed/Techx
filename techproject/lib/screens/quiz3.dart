...
import 'package:techproject/screens/quiz4.dart';
          ...
          Padding(
            ...
            child: Column(
              children: [
                ...
                Stack(
                  children: [
                    LinearProgressIndicator(
                      value: 0.3, // 20% d'orange par-dessus
                ...
                QuizOption(
                    text: "I didn't like something that happened.",
                    onPressed: () => _goToNextPage(context)),
                QuizOption(
                    text: "Someone made me feel upset.",
                    onPressed: () => _goToNextPage(context)),

                QuizOption(
                    text: "I don't know, just feeling this way.",
                    onPressed: () => _goToNextPage(context)),
              ],
            ),
          ),
